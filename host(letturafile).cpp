    ...
    for (size_t idx = 0; idx < listfiles.size(); ++idx) {
        ...
        while (std::getline(loadfile, line)) {
            ...
            if (type == 20) {
                ...
                rings_array[0] = std::stof(linedata[5]);
                rings_array[1] = std::stof(linedata[6]);
                rings_array[2] = std::stof(linedata[7]);
            }
            ...
            if (type == 23) {
                ...
                rings_array[3] = std::stoi(linedata[4]);
...
//NON CHIARO COME FARE CON BUFFER INOUT E BUFFER OUTPUT (FORSE COME HO FATTO E' OK)
            ...
            auto increment_run = xrt::run(increment);
